...
const LoginPage = ({ setRole }) => {
  ...
  const handleLogin = async (e) => {
    ...
    setLoading(true);
    console.log("🔐 Sending login request:", { officeId, password, role });

    try {
      const res = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/auth/login`,
        { officeId, password, role }
      );

      const { token, fullName, role: resRole } = res.data;
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="superadmin" className="text-black bg-white">Superadmin</option>
